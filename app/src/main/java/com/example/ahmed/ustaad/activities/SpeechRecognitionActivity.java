...
public class SpeechRecognitionActivity extends BaseActivity implements MessageDialogFragment.Listener, DrawFragment.DrawFragmentCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting DrawFragment in frameLayoutFragmentContainer
        this.drawFragment = new DrawFragment();
        //getting framgment manager
        FragmentManager fragmentManager = this.getSupportFragmentManager();
        //beginning fragment transaction
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        //adding drawFragment to fragment_container
        fragmentTransaction.add(R.id.fragment_container, drawFragment);
        ...
        this.initialSequenceMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                SpeechRecognitionActivity.this.imageViewMic.setEnabled(true);
                SpeechRecognitionActivity.this.startRecognition();
            }
        });
        this.sequenceMediaPlayer = new SequenceMediaPlayer(this, new ArrayList<Integer>(Arrays.asList(R.raw.write_dotted_words, R.raw.navigation_converted, R.raw.back_to_menu)));
    ...
    private void setViewsClickListeners() {
        this.imageViewMic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SpeechRecognitionActivity.this.imageViewMic.setEnabled(false);
    ...
    private void startRecognition() {
        ...
        SpeechRecognitionActivity.this.rippleBackground.startRippleAnimation();
        ...
        SpeechRecognitionActivity.this.stopVoiceRecorder();
        SpeechRecognitionActivity.this.startVoiceRecorder();
    }
    ...
    public void onSimilarityCheckComplete(float similarity) {
        ...
        if(similarity > 0.4) {
            ...
            sequenceMediaPlayer.clear();
            sequenceMediaPlayer.setAudioFilesArray(new ArrayList<Integer> (Arrays.asList(R.raw.wrong_only, R.raw.write_dotted_words, R.raw.navigation_converted, R.raw.back_to_menu)));
            sequenceMediaPlayer.start();
    ...
    private final SpeechService.Listener mSpeechServiceListener =
            new SpeechService.Listener() {
                ...
                public void onSpeechRecognized(final String text, final boolean isFinal) {
                    ...
                    if (drawFragment != null && !TextUtils.isEmpty(text)) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                if (isFinal) {
                                    ...
                                    drawFragment.setWord(firstWord);

                                    //starting sequence media player
                                    sequenceMediaPlayer.clear();
                                    sequenceMediaPlayer.setAudioFilesArray(new ArrayList<Integer>(Arrays.asList(R.raw.write_dotted_words, R.raw.navigation_converted, R.raw.back_to_menu)));
    ...
    public void nextButtonSelected(View view) {
        if(this.drawFragment.getWord().length() > 0) {
